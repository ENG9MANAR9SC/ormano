...
@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-semibold tracking-tight text-slate-900">New case</h1>
        <p class="mt-1 text-sm text-slate-600">Register a matter with type, status, and links.</p>
    </div>
