...
@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-semibold tracking-tight text-slate-900">New client</h1>
        <p class="mt-1 text-sm text-slate-600">Create a client record for case linking.</p>
    </div>
